...
const SUGGESTED_QUESTIONS = [
  { icon: Package, text: "Tra cứu đơn hàng SPxxxx", color: "from-blue-500 to-cyan-500" },
...
export default function ChatPopupTop({ onClose }) {
  ...
  const handleSend = async (text) => {
    ...
    try {
      ...
      // Hiện typing indicator 3s rồi hiện full text
              ...
              {messages.map((m, i) => (
                ...
                >
                  ...
                  <div className="flex flex-col max-w-[85%]">
                    ...
                    >
                      {m.from === "bot" ? (
                        <div className="prose prose-sm max-w-none prose-p:my-1 prose-headings:text-[#113e48] prose-a:text-blue-600 prose-strong:text-[#113e48]">
                          <ReactMarkdown
                            ...
                            components={{
                              ...
                              ul: ({ node, ...props }) => (
                                <ul {...props} className="list-none ml-0 my-2 space-y-1" />
                              ),
                              li: ({ node, ...props }) => (
                                <li
                                  {...props}
                              ...
                              h1: ({ node, ...props }) => (
                                <h1 {...props} className="text-lg font-bold text-[#113e48] mt-2 mb-1" />
                              ),
                              h2: ({ node, ...props }) => (
                                <h2 {...props} className="text-base font-bold text-[#113e48] mt-2 mb-1" />
                              ),
                              h3: ({ node, ...props }) => (
                                <h3 {...props} className="text-sm font-bold text-[#113e48] mt-1 mb-1" />
                              ),
