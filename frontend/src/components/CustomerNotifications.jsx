...
import { Bell, Package, CheckCircle2, Truck, XCircle, CheckCircle } from "lucide-react";
...
// Tải danh sách thông báo
  ...
  useEffect(() => {
    const handleCustomToast = (e) => {
      ...
      setToasts((prev) => [...prev, { id: toastId, message, duration: duration || 6000 }]);
    };
    window.addEventListener("showCustomToast", handleCustomToast);
    return () => window.removeEventListener("showCustomToast", handleCustomToast);
  }, []);
